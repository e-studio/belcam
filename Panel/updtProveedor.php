<?php
  ...
  $respuesta = Datos::mdlBuscaProveedor("proveedores",$usuario);
?>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-2">
                  <label>Codigo</label>
                  <input type="text" class="form-control" value="<?php echo $respuesta['codProveedor']; ?>" name="codProveedor" required="true" >
                </div>
                <div class="col-xs-6">
                  <label>Nombre</label>
