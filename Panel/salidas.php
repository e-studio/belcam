          ...
          <div class="col-md-12">
              <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-xs-3">
                      <label>Flete</label>
                      <input type="text" required id="flete" name="flete" value="0" class="form-control" onblur="recalcula()">
                      </div>
                      <div class="col-xs-3">
                        <label>Maniobra</label>
                        <input type="text" required id="maniobra" name="maniobra" value="0" class="form-control" onblur="recalcula()">
                      </div>
                    ...
                    <div class="col-xs-3">
                      ...
                      <div class="col-xs-3">
                        ...
                        <input type="text" readonly="true" value="0" id="totalVenta" name="total" class="form-control">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-3">
                        ...
                        <input type="text" readonly="true" value="0" id="costoUnitario" name="costoUnitario" class="form-control">
                      </div>
                      <div class="col-xs-3">
                        <label>Comision</label>
                        <input type="number" value="0" id="costoComision" name="costoComision" class="form-control" onblur="recalcula()">
                        <!-- <input type="number" pattern="^\d*(\.\d{0,2})?$" step="0.1" value="0" id="comision" name="comision" class="form-control"> -->
                      </div>

                      <div class="col-xs-3">
                        <label>Costo</label>
                        <input type="text" readonly="true" value="0" id="costo" name="costo" class="form-control">
                        <input type="hidden" readonly="true" value="0" id="costoInicial" name="costoInicial" class="form-control">
                      </div>
                      <div class="col-xs-2">
                  ...
                  <div class="col-xs-6">
                    <div class="card">
                          ...
                          <label class="checkbox-label">
                              <input type="checkbox" id="revisado" onchange="grabarOn(this.value)">
                              <span class="checkbox-custom rectangular"></span>
                          </label>
                          <div class="input-title">Revisado</div>
                          </div>
                          <!-- <div class="clear"></div> -->
                      </div>

                  </div>
                  <div class="col-xs-6"><button type="submit" disabled="true" id="btnGrabar" class="btn btn-primary">Guardar</button></div>
              </div>
            </div>
          </div> <!-- Caja de Guardar-->
      </div>  <!-- Row -->
