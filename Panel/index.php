...
<head>
  ...
  <title>Panel de Control | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Panel de Control</b><br>Belcam</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" value="submit" name="usuarioIngreso" class="btn btn-primary btn-block btn-flat">Ingresar</button>
        </div>
        <!-- /.col -->
      </div>
      <?php
